  ...
  return (
    <View style={styles.userWindow}>
      ...
      <View>
        ...
        <Pressable><Text style={styles.actionButtonText}>Add New Availability Window</Text></Pressable>
      </View>
    </View>
  );
}
...
export function UpcomingMeetings(currentUser: User) {
  ...
  return (
    <View style={styles.upcomingMeetingWindow}>
      ...
      <Pressable><Text style={styles.actionButtonText}>Schedule New Meeting</Text></Pressable>
    </View>
  );
}
...
export function Logout() {
  return (
    <View>
      <Pressable><Text style={styles.actionButtonText}>Logout</Text></Pressable>
    </View>
  );
}
